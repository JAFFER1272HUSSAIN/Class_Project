...
void printHeader()
{
	...
	cout << "            S:::::S          H:::::H     H:::::H          M::::::M     MMMMM     M::::::M                    S:::::S " << endl;
...
void viewEmployees()
{
	...
	printHeader();
	cout << "\t\t"
		 << " MAIN MENU >> HR >> ALL EMPLOYEES " << endl;
...
void addEmployees()
{
	system("cls");
	printHeader();
	cout << "\t\t"<< "MAIN MENU >> HR >> ADD EMPLOYEES " << endl;
	string application;
...
void removeEmployees()
{
	system("cls");
	printHeader();
	cout << "\t\t" << "MAIN MENU >> HR >> REMOVE ANY EMPLOY" << endl;
...
void ClientsMenu()
{
	...
	system("cls");
	printHeader();
	cout << "\t\t" << "MAIN MENU >> HR >> CLIENT'S MENU" << endl;
...
void Employees()
{
	system("cls");
	printHeader();
	cout << "\t\t" << "MAIN MENU >> EMPLOYEES MENU" << endl;
